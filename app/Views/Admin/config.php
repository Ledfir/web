            ...
            <div class="row g-3">
              <div class="col-sm-6">
                ...
                <div class="input-group">
                  ...
                  <input type="tel" class="form-control" placeholder="81 1234 5678" value="81 2345 6789">
                </div>
              </div>
              <div class="col-sm-6">
                <label class="form-label">Correo de contacto</label>
                <input type="email" class="form-control" placeholder="contacto@empresa.com" value="contacto@aurea.com">
              </div>
              <div class="col-12">
                <label class="form-label">Dirección</label>
                <input type="text" class="form-control" placeholder="Calle, número, colonia, ciudad" value="Av. Constitución 400, Centro, Monterrey, N.L.">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="panel">
            ...
            <div class="row g-3">
              <div class="col-lg-7">
                ...
                <textarea class="form-control" rows="5" placeholder="Escribe el mensaje...">Hola, vengo del sitio web y me gustaría solicitar una cotización.</textarea>
              ...
              <div class="col-lg-5">
                ...
                <div class="wa-preview">
                  ...
                  <div class="wa-bubble">
                    Hola, vengo del sitio web y me gustaría solicitar una cotización.
                  </div>
                </div>
              </div>
            </div>
